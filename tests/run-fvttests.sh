...
sparkJarVersion=$(mvn help:evaluate -f cohort-parent -Dexpression=project.version -q -DforceStdout)
sparkJarPath="local:///opt/spark/jars/cohort-evaluator-spark-${sparkJarVersion}.jar"
